...
import 'package:hotel_booking_app/next_4.dart';
      ...
      body: Column(
        children: [
          SizedBox(
            ...
            child: const Image(image: AssetImage("Assets/Rectangle 12 (2).png"),fit: BoxFit.cover,),
          ),
          ...
          Padding(
            ...
            child: InkWell(
              onTap: () {
                Navigator.push(context, MaterialPageRoute(builder: (context) => const Next4(),));
              },
              child: Container(
                height: 45,
                width: 400,
